            ...
            <div class="single-item-carousel owl-carousel owl-theme">
                <!-- Slide -->
                   ...
                   <div class="slide">
                    ...
                    <div class="slider-one_pattern-layer"
                        style="background-image:url({{asset('image')}}/{{$section->image}})"></div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="graph-outer">
                                                <input type="text" class="dial" data-fgColor="#c20b0b"
                                                    ...
                                                    data-linecap="normal" value="50" data-thickness="0.10">
                                                <div class="inner-text count-box"><span class="count-text"
                                                        data-stop="50" data-speed="3500"></span>%</div>
                                            </div>
                                    ...
                                    <div class="counter-boxed col-lg-6 col-md-6 col-sm-12">
                                        <div class="d-flex align-items-center">
                                            <div class="graph-outer">
                                                <input type="text" class="dial" data-fgColor="#c20b0b"
                                                    data-bgColor="#ffffff" data-width="110" data-height="110"
                                                    data-linecap="normal" value="75" data-thickness="0.10">
                                                <div class="inner-text count-box"><span class="count-text"
                                                        data-stop="75" data-speed="3500"></span>%</div>
                                            </div>
                        ...
                        <div class="about-one_image-column col-lg-5 col-md-12 col-sm-12">
                            <div class="about-one_image-inner">
                                <div class="about-one_counter-box" data-parallax='{"y" : 80}'>
                                    <div class="about-one_counter"><span class="odometer"
                                            data-count="10"></span><sup>+</sup></div>
                            ...
                            <div class="service-block_one-overlay"
                                ...
                                <div class="service-block_one-overlay-inner">
                                    <div class="upper-box">
                                        ...
                                        <h5 class="service-block_one-heading-two"><a
                                                href="service-detail.html">Program management</a></h5>
                                    </div>
                            ...
                            <div class="service-block_one-overlay"
                                ...
                                <div class="service-block_one-overlay-inner">
                                    <div class="upper-box">
                                        ...
                                        <h5 class="service-block_one-heading-two"><a
                                                href="service-detail.html">Investment Policy</a></h5>
                                    </div>
                                    <div class="service-block_one-text-two">Collaborate Consulting exists to find the
                                        place where to being seemingly disparate interests meet.</div>
                                    <!-- Button Box -->
                            ...
                            <div class="service-block_one-overlay"
                                ...
                                <div class="service-block_one-overlay-inner">
                                    <div class="upper-box">
                                        ...
                                        <h5 class="service-block_one-heading-two"><a
                                                href="service-detail.html">Financial Advices</a></h5>
                                    </div>
                                    <div class="service-block_one-text-two">Collaborate Consulting exists to find the
                                        place where to being seemingly disparate interests meet.</div>
                                    <!-- Button Box -->
                            ...
                            <div class="service-block_one-overlay"
                                ...
                                <div class="service-block_one-overlay-inner">
                                    <div class="upper-box">
                                        ...
                                        <h5 class="service-block_one-heading-two"><a
                                                href="service-detail.html">Business Growth Plan</a></h5>
                                    </div>
                                    <div class="service-block_one-text-two">Collaborate Consulting exists to find the
                                        place where to being seemingly disparate interests meet.</div>
                                    <!-- Button Box -->
            ...
            <div class="auto-container">
                <div class="row clearfix">
                        ...
                        <div class="progress-one_content-inner">
                            ...
                            <div class="default-skills">
                                ...
                                <div class="default-skill-item">
                                    ...
                                    <div class="default-count-box count-box"><span class="count-text"
                                ...
                                <div class="default-skill-item">
                                    ...
                                    <div class="default-count-box count-box"><span class="count-text"
                                            data-speed="2000" data-stop="90">0</span>%</div>
                    ...
                    <div class="progress-one_image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="progress-one_image wow fadeInRight" data-wow-delay="0ms"
                            data-wow-duration="1500ms">
